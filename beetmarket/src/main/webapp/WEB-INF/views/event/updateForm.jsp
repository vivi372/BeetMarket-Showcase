...
<div class="container">
	...
	<form action="update.do" method="post">
			...
			<div class="form-group">
				...
				<input id="startDate" name="startDate" required autocomplete="off" class="form-control datepicker" value="<fmt:formatDate value="${vo.startDate }" pattern="yyyy-MM-dd"/>">
			</div>
			<div class="form-group">
				<label for="endDate">종료일</label>
				<input id="endDate" name="endDate" required autocomplete="off" class="form-control datepicker" value="<fmt:formatDate value="${vo.endDate }" pattern="yyyy-MM-dd"/>">
			</div>
			<div class="form-group">
