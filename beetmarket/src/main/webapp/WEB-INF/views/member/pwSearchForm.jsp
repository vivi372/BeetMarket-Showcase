...
<div class="card align-middle" style="width:25rem;">
	<div class="card-title" style="margin-top:30px;">
		...
		<div class="card-body">
	      <form action="pwSearch.do" class="form-signin" method="POST">
	        <input  name="id" id="id" class="form-control" placeholder="아이디" required autofocus><BR>
        ...
        <div class="links">
            <a href="searchForm.do">아이디 찾기</a> | <a href="loginForm.do">로그인</a> | <a href="writeForm.do">회원가입</a>
        </div>
</div>
</body>
</html>