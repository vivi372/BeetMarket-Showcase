...
<script>
$(function(){
	let cateno=${list[0].cateno}
	$("#faqtoplist").load("/faqajax/list.do?cateno="+cateno+"&ismain=1");
	
	$("#faqtoplist").on("click", ".datarow", function(){
...
<div class="container">
  <form action="searchlist.do" id="searchForm">
  	...
  	<input name="cateno" value="${list[0].cateno }" type="hidden">
  ...
  <div class="card">
  	...
  	<div class="card-body">
		...
		<div>
			<pageNav:pageNav listURI="faqlist.do" pageObject="${po }"></pageNav:pageNav>
